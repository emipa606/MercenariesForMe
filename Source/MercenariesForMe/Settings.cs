...
public class Settings : ModSettings
{
    ...
    private static bool imprisonedMercenariesAreNoLongerMerc = true;
    private static string lastVersionInfo = "";
    public static bool allowNonZeroOtherSkillsMerc;
    public static int buyMercSalaryMultiplier = 8;
    public static float rateDecreaseAppliedToRentedMercSalary = 0.45f;
    public static bool preventNonMercenariesPawnSpawnWithUSFMStuff;
    public static List<string> mustHaveTraits = [];
    ...
    private static int cyborgBionicModSource = -1;

    public static List<string> blacklistedTraitsV2 =
    [
        "wimp", "pyromaniac", "abrasive", "nervous", "volatile", "psychically hypersensitive", "psychically sensitive",
        "pessimist", "depressive"
    ];

    public static int minTimeUSFMSuspended = 480000;
    public static int maxTimeUSFMSuspended = 1200000;
    public static bool onlyVanillaForWeapon;

    public static bool onlyVanillaForGear;

    //public static bool onlyVanillaForCyborg = false;
    public static bool hideMercenariesIcon;
    public static bool hideMercenariesLevel;

    private static bool disableNotifWhenDisusedMercDie;
    ...
    public static int minEliteMelee;
    public static int maxEliteMelee = 25;
    public static int minCyborgMelee;
    ...
    public static int minEliteRanged;
    public static int maxEliteRanged = 25;
    public static int minCyborgRanged;
    ...
    public static int minElite;
    public static int maxElite = 8;
    public static int minCyborg;
    ...
    private static float maxPercentDisusedMercCanDiePerQuad = 0.10f;
    ...
    public static void DoSettingsWindowContents(Rect inRect)
    {
        ...
        var scrollRect = new Rect(0f, 0f, inRect.width - 16f,
            (inRect.height * 10f) + (blacklistedTraitsV2.Count * 55) + (blacklistedPawnKind.Count * 55) +
            (hediffToNotClear.Count * 55) + (blacklistedWeapons.Count * 55) + (mustHaveTraits.Count * 55) + 800);
        ...
        list.CheckboxLabeled("MFM_SettingsImprisonedMercenariesAreNoLongerMerc".Translate(),
            ref imprisonedMercenariesAreNoLongerMerc);

        var buffMinXPRentedMercs = minXPRentedMercs.ToString();
        var buffMaxXPRentedMercs = maxXPRentedMercs.ToString();
        var buffPowerBeamCost = powerBeamCost.ToString();

        list.CheckboxLabeled("MFM_SettingsAllowMercNonZeroOtherSkills".Translate(), ref allowNonZeroOtherSkillsMerc);

        var prevPreventNonMercenariesPawnSpawnWithUSFMStuff = preventNonMercenariesPawnSpawnWithUSFMStuff;
        list.CheckboxLabeled("MFM_SettingsPreventNonMercSpawnWithUSFMStuff".Translate(),
            ref preventNonMercenariesPawnSpawnWithUSFMStuff);
        ...
        list.CheckboxLabeled("MFM_SettingsDisableNotifWhenDisusedMercDie".Translate(),
            ref disableNotifWhenDisusedMercDie);
        list.Label("MFM_SettingsPercentDisusedMercCanDiePerQuad".Translate((int)(maxPercentDisusedMercCanDiePerQuad *
            100)));
        ...
        var buffTransportQuickPrice = transportQuickPrice.ToString();
        var buffTransportImmediatePrice = transportImmediatePrice.ToString();
        ...
        var buffPriceRecruit = priceRecruit.ToString();
        var buffPriceConfirmed = priceConfirmed.ToString();
        var buffPriceVeteran = priceVeteran.ToString();
        var buffPriceElite = priceElite.ToString();
        var buffPriceCyborg = priceCyborg.ToString();
        var buffGuaranteeRecruit = guaranteeRecruit.ToString();
        var buffGuaranteeConfirmed = guaranteeConfirmed.ToString();
        var buffGuaranteeVeteran = guaranteeVeteran.ToString();
        var buffGuaranteeElite = guaranteeElite.ToString();
        var buffGuaranteeCyborg = guaranteeCyborg.ToString();
        var buffPriceGear1 = priceGear1.ToString();
        var buffPriceGear2 = priceGear2.ToString();
        var buffPriceGear3 = priceGear3.ToString();
        var buffPriceWeapon1 = priceWeapon1.ToString();
        var buffPriceWeapon2 = priceWeapon2.ToString();
        var buffPriceWeapon3 = priceWeapon3.ToString();
        var buffPriceWeapon4 = priceWeapon4.ToString();
        ...
        list.Label("MFM_SettingsSalaryDecreaseRateAppliedToRentedMerc".Translate(
            (int)(rateDecreaseAppliedToRentedMercSalary * 100)));
        ...
        var buffMinRecruit = minRecruit.ToString();
        var buffMaxRecruit = maxRecruit.ToString();
        var buffMinConfirmed = minConfirmed.ToString();
        var buffMaxConfirmed = maxConfirmed.ToString();
        var buffMinVeteran = minVeteran.ToString();
        var buffMaxVeteran = maxVeteran.ToString();
        var buffMinElite = minElite.ToString();
        var buffMaxElite = maxElite.ToString();
        var buffMaxCyborg = maxCyborg.ToString();
        var buffMinCyborg = minCyborg.ToString();

        var buffMinRecruitMelee = minRecruitMelee.ToString();
        var buffMaxRecruitMelee = maxRecruitMelee.ToString();
        var buffMinConfirmedMelee = minConfirmedMelee.ToString();
        var buffMaxConfirmedMelee = maxConfirmedMelee.ToString();
        var buffMinVeteranMelee = minVeteranMelee.ToString();
        var buffMaxVeteranMelee = maxVeteranMelee.ToString();
        var buffMinEliteMelee = minEliteMelee.ToString();
        var buffMaxEliteMelee = maxEliteMelee.ToString();
        var buffMinCyborgMelee = minCyborgMelee.ToString();
        var buffMaxCyborgMelee = maxCyborgMelee.ToString();

        var buffMinRecruitRanged = minRecruitRanged.ToString();
        var buffMaxRecruitRanged = maxRecruitRanged.ToString();
        var buffMinConfirmedRanged = minConfirmedRanged.ToString();
        var buffMaxConfirmedRanged = maxConfirmedRanged.ToString();
        var buffMinVeteranRanged = minVeteranRanged.ToString();
        var buffMaxVeteranRanged = maxVeteranRanged.ToString();
        var buffMinEliteRanged = minEliteRanged.ToString();
        var buffMaxEliteRanged = maxEliteRanged.ToString();
        var buffMinCyborgRanged = minCyborgRanged.ToString();
        var buffMaxCyborgRanged = maxCyborgRanged.ToString();
        ...
        list.CheckboxLabeled(
            "MFM_SettingsIncidentsRaid".Translate() + Utils.SEP + "MFM_SettingsIncidentEnable".Translate(),
            ref enableIncidentRaid);
        list.CheckboxLabeled(
            "MFM_SettingsIncidentsCounterOffer".Translate() + Utils.SEP + "MFM_SettingsIncidentEnable".Translate(),
            ref enableIncidentCounterOffer);

        list.Label("MFM_SettingsIncidentsCounterOffer".Translate() + Utils.SEP +
                   "MFM_SettingsIncidentsCounterOfferMinPrice".Translate((int)(minRateIncSalaryIncidentCounterOffer *
                                                                               100)));
        minRateIncSalaryIncidentCounterOffer = list.Slider(minRateIncSalaryIncidentCounterOffer, 0.5f, 20f);
        list.Label("MFM_SettingsIncidentsCounterOffer".Translate() + Utils.SEP +
                   "MFM_SettingsIncidentsCounterOfferMaxPrice".Translate((int)(maxRateIncSalaryIncidentCounterOffer *
                                                                               100)));
        ...
        if (toDel != null)
        {
            foreach (var el in toDel)
            {
                ...
                Messages.Message("MFM_MsgMustHaveTraitInBlacklistedTraits".Translate(el),
    ...
    public override void ExposeData()
    {
        ...
        Scribe_Values.Look(ref lastVersionInfo, "lastVersionInfo", "");

        Scribe_Values.Look(ref allowNonZeroOtherSkillsMerc, "allowNonZeroOtherSkillsMerc");
        Scribe_Values.Look(ref buyMercSalaryMultiplier, "buyMercSalaryMultiplier", 8);
        Scribe_Values.Look(ref rateDecreaseAppliedToRentedMercSalary, "rateDecreaseAppliedToRentedMercSalary", 0.45f);
        Scribe_Values.Look(ref preventNonMercenariesPawnSpawnWithUSFMStuff,
            "preventNonMercenariesPawnSpawnWithUSFMStuff");

        Scribe_Values.Look(ref percentIncomeDecreaseSlave, "percentIncomeDecreaseSlave", 0.30f);
        Scribe_Values.Look(ref currentEpoch, "currentEpoch");

        Scribe_Values.Look(ref medievalModeMinHourDeliveryCaravan, "medievalModeMinHourDeliveryCaravan", 8);
        Scribe_Values.Look(ref medievalModeMaxHourDeliveryCaravan, "medievalModeMaxHourDeliveryCaravan", 48);

        Scribe_Values.Look(ref allowNonViolentToBeRented, "allowNonViolentToBeRented", true);
        Scribe_Values.Look(ref minXPRentedMercs, "minXPRentedMercs", 600);
        Scribe_Values.Look(ref maxXPRentedMercs, "maxXPRentedMercs", 3000);

        Scribe_Values.Look(ref minAge, "minAge", 18);
        Scribe_Values.Look(ref maxAge, "maxAge", 80);

        Scribe_Values.Look(ref riskCyborgRemovingPartExplode, "riskCyborgRemovingPartExplode", 0.75f);
        Scribe_Values.Look(ref cyborgBionicModSource, "cyborgBionicModSource", -1);

        Scribe_Values.Look(ref minDiscount, "minDiscount", 0.15f);
        Scribe_Values.Look(ref maxDiscount, "maxDiscount", 0.55f);

        Scribe_Values.Look(ref mercJoinNbSalaryToPay, "mercJoinNbSalaryToPay", 3);
        Scribe_Values.Look(ref minRateIncSalaryIncidentCounterOffer, "minRateIncSalaryIncidentCounterOffer", 1.0f);
        Scribe_Values.Look(ref maxRateIncSalaryIncidentCounterOffer, "maxRateIncSalaryIncidentCounterOffer", 3.0f);

        Scribe_Values.Look(ref enableIncidentCounterOffer, "enableIncidentCounterOffer", true);
        Scribe_Values.Look(ref enableIncidentRaid, "enableIncidentRaid", true);

        Scribe_Values.Look(ref powerBeamCost, "powerBeamCost", 25000);
        Scribe_Values.Look(ref minTimeUSFMSuspended, "minTimeUSFMSuspended", 480000);
        Scribe_Values.Look(ref maxTimeUSFMSuspended, "maxTimeUSFMSuspended", 1200000);

        Scribe_Values.Look(ref badMoodNbhPerQuadFloor, "badMoodNbhPerQuadFloor", 72);
        Scribe_Values.Look(ref goodMoodNbhPerQuadFloor, "goodMoodNbhPerQuadFloor", 96);
        Scribe_Values.Look(ref badMoodCoefIncCost, "badMoodCoefIncCost", 0.30f);
        Scribe_Values.Look(ref goodMoodCoefDecCost, "goodMoodCoefDecCost", 0.25f);

        Scribe_Values.Look(ref minHourDeliverStuffAndGuarantee, "minHourDeliverStuffAndGuarantee", 2);
        Scribe_Values.Look(ref maxHourDeliverStuffAndGuarantee, "maxHourDeliverStuffAndGuarantee", 9);

        Scribe_Values.Look(ref onlyVanillaForWeapon, "onlyVanillaForWeapon");
        Scribe_Values.Look(ref onlyVanillaForGear, "onlyVanillaForGear");
        //Scribe_Values.Look<bool>(ref onlyVanillaForCyborg, "onlyVanillaForCyborg", false);

        Scribe_Values.Look(ref hideMercenariesIcon, "hideMercenariesIcon");
        Scribe_Values.Look(ref hideMercenariesLevel, "hideMercenariesLevel");
        Scribe_Values.Look(ref disableNotifWhenDisusedMercDie, "disableNotifWhenDisusedMercDie");
        Scribe_Values.Look(ref timeBeforeRenewOffers, "timeBeforeRenewOffers", 1800000);

        Scribe_Values.Look(ref transportQuickMinHour, "transportQuickMinHour", 12);
        Scribe_Values.Look(ref transportQuickMaxHour, "transportQuickMaxHour", 24);
        Scribe_Values.Look(ref transportStandardMinHour, "transportStandardMinHour", 24);
        Scribe_Values.Look(ref transportStandardMaxHour, "transportStandardMaxHour", 240);

        Scribe_Values.Look(ref transportQuickPrice, "transportQuickPrice", 250);
        Scribe_Values.Look(ref transportImmediatePrice, "transportImmediatePrice", 500);


        Scribe_Values.Look(ref minRecruitMelee, "minRecruitMelee", 15);
        Scribe_Values.Look(ref maxRecruitMelee, "maxRecruitMelee", 100);
        Scribe_Values.Look(ref minConfirmedMelee, "minConfirmedMelee", 5);
        Scribe_Values.Look(ref maxConfirmedMelee, "maxConfirmedMelee", 75);
        Scribe_Values.Look(ref minVeteranMelee, "minVeteranMelee", 1);
        Scribe_Values.Look(ref maxVeteranMelee, "maxVeteranMelee", 50);
        Scribe_Values.Look(ref minEliteMelee, "minEliteMelee");
        Scribe_Values.Look(ref maxEliteMelee, "maxEliteMelee", 25);
        Scribe_Values.Look(ref minCyborgMelee, "minCyborgMelee");
        Scribe_Values.Look(ref maxCyborgMelee, "maxCyborgMelee", 10);

        Scribe_Values.Look(ref minRecruitRanged, "minRecruitRanged", 15);
        Scribe_Values.Look(ref maxRecruitRanged, "maxRecruitRanged", 100);
        Scribe_Values.Look(ref minConfirmedRanged, "minConfirmedRanged", 5);
        Scribe_Values.Look(ref maxConfirmedRanged, "maxConfirmedRanged", 75);
        Scribe_Values.Look(ref minVeteranRanged, "minVeteranRanged", 1);
        Scribe_Values.Look(ref maxVeteranRanged, "maxVeteranRanged", 50);
        Scribe_Values.Look(ref minEliteRanged, "minEliteRanged");
        Scribe_Values.Look(ref maxEliteRanged, "maxEliteRanged", 25);
        Scribe_Values.Look(ref minCyborgRanged, "minCyborgRanged");
        Scribe_Values.Look(ref maxCyborgRanged, "maxCyborgRanged", 10);

        Scribe_Values.Look(ref minRecruit, "minRecruit", 10);
        Scribe_Values.Look(ref maxRecruit, "maxRecruit", 45);
        Scribe_Values.Look(ref minConfirmed, "minConfirmed", 5);
        Scribe_Values.Look(ref maxConfirmed, "maxConfirmed", 25);
        Scribe_Values.Look(ref minVeteran, "minVeteran", 1);
        Scribe_Values.Look(ref maxVeteran, "maxVeteran", 15);
        Scribe_Values.Look(ref minElite, "minElite");
        Scribe_Values.Look(ref maxElite, "maxElite", 8);
        Scribe_Values.Look(ref minCyborg, "minCyborg");
        Scribe_Values.Look(ref maxCyborg, "maxCyborg", 10);

        Scribe_Values.Look(ref priceGear1, "priceGear1", 745);
        Scribe_Values.Look(ref priceGear2, "priceGear2", 1200);
        Scribe_Values.Look(ref priceGear3, "priceGear3", 2700);

        Scribe_Values.Look(ref priceWeapon1, "priceWeapon1", 250);
        Scribe_Values.Look(ref priceWeapon2, "priceWeapon2", 600);
        Scribe_Values.Look(ref priceWeapon3, "priceWeapon3", 900);
        Scribe_Values.Look(ref priceWeapon4, "priceWeapon4", 1600);

        Scribe_Values.Look(ref priceRecruit, "priceRecruit", 400);
        Scribe_Values.Look(ref priceConfirmed, "priceConfirmed", 750);
        Scribe_Values.Look(ref priceVeteran, "priceVeteran", 1000);
        Scribe_Values.Look(ref priceElite, "priceElite", 1400);
        Scribe_Values.Look(ref priceCyborg, "priceCyborg", 2500);

        Scribe_Values.Look(ref guaranteeRecruit, "guaranteeRecruit", 400);
        Scribe_Values.Look(ref guaranteeConfirmed, "guaranteeConfirmed", 750);
        Scribe_Values.Look(ref guaranteeVeteran, "guaranteeVeteran", 1000);
        Scribe_Values.Look(ref guaranteeElite, "guaranteeElite", 1400);
        Scribe_Values.Look(ref guaranteeCyborg, "guaranteeCyborg", 2500);


        Scribe_Collections.Look(ref mustHaveTraits, "mustHaveTraits", LookMode.Value);
        Scribe_Collections.Look(ref blacklistedWeapons, "blacklistedWeapons", LookMode.Value);
        Scribe_Collections.Look(ref blacklistedPawnKind, "blacklistedPawnKind", LookMode.Value);
        Scribe_Collections.Look(ref blacklistedTraitsV2, "blacklistedTraitsV2", LookMode.Value);
        Scribe_Collections.Look(ref hediffToNotClear, "hediffToNotClear", LookMode.Value);
        Scribe_Values.Look(ref imprisonedMercenariesAreNoLongerMerc, "imprisonedMercenariesAreNoLongerMerc", true);
        Scribe_Values.Look(ref setBasicWorkTypeToOne, "setBasicWorkTypeToOne", true);
    ...
    private static void resetMustHaveTraits()
    {
        mustHaveTraits = [];
    }
    ...
    private static void resetBlacklistedTraits()
    {
        blacklistedTraitsV2 =
        [
            "wimp", "pyromaniac", "abrasive", "nervous", "volatile", "psychically hypersensitive",
            "psychically sensitive", "pessimist", "depressive"
        ];
    }

    private static void resetHediffToNotClear()
    {
        hediffToNotClear = ["DummyPrivates", "DummyPrivatesForModdedPawnsOnBirthday"];
    }

    private static void resetBlacklistedWeapons()
    {
        blacklistedWeapons = [];
    }
