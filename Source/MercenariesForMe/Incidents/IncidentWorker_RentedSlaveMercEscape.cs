...
public class IncidentWorker_RentedSlaveMercEscape : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        try
        {
            ...
            var salary = merc.TryGetComp<Comp_USFM>().salary * 2;
            ...
            Find.LetterStack.ReceiveLetter("MFM_LetterRentedSlaveMercEscape".Translate(),
                "MFM_LetterRentedSlaveMercEscapeDesc".Translate(merc.Label,
                    Utils.getReadableType(merc.TryGetComp<Comp_USFM>().type), salary, Utils.getUSFMLabel()),
