        ...
        public static Pawn generateMerc(MercenaryType type, MercenaryLevel level, int gear, int weapon, int intGearColor, string defNameRace=null, bool purchased=false)
         {
            ...
            PawnGenerationRequest pgr = new PawnGenerationRequest(pawnKindDef, Faction.OfPlayer, PawnGenerationContext.NonPlayer, -1, false, false, false, false, true, true, 1f, false, true, true, false, false, false, false, false, 0f, 0f, null);
